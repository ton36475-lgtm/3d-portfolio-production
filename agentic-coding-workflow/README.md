...
Shared source of truth: **[ton36475-lgtm/3d-portfolio-production](https://github.com/ton36475-lgtm/3d-portfolio-production)**
...
```bash
git clone https://github.com/ton36475-lgtm/3d-portfolio-production.git
cd 3d-portfolio-production
...
```
src/                         # the atelier app (TanStack Start + R3F)
